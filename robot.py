...
class Robot:
    ...
    def _move_to_location_rt(self, angleDiff, goal):
        ...
        while (abs(motorAngles[0][0] - refAngle[0]) > self.epsilon) and (abs(motorAngles[1][0] - refAngle[1]) > self.epsilon):             
                ...
                newLoc = self.pc.getBestLocation()
                z5 = time.time()
                print "Updating location took {0}, sonar took {1}".format(z5 - z1, z2 - z1)
                ...
                if goalError > errCutoff and distanceRemaining > errCutoff:
                    ...
                    print "Think I'm at ", newLoc, ". And I'm heading for ", estDest, "Now heading for ", newProjDest, "There is ", distanceRemaining, "cm left on the drive program, with a minDistance of ", minDistance, "proj error ", projError
